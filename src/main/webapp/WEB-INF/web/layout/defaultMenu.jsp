      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
                    ...
                    <li ><a href="${pageContext.request.contextPath}/cuenMain"><i class="fa fa-circle-o"></i> Cuenta</a></li>
                    <li ><a href="${pageContext.request.contextPath}/manuMain"><i class="fa fa-circle-o"></i> CategoriaManufactura</a></li>
